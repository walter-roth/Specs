# Copied from https://github.com/couchbase/couchbase-lite-ios/blob/master/Podspec/couchbase-lite-ios.podspec
...
Pod::Spec.new do |s|
  ...
  s.author          = 'Couchbase'
  s.source          = { :http => 'http://latestbuilds.hq.couchbase.com/couchbase-lite-ios/1.3.1/ios/1.3.1-6/couchbase-lite-ios-community_1.3.1-6.zip' }
